...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "8Bit.lnk";
}
...
{
    return GetAutostartDir() / "8bit.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("8Bit-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  8bit-qt [" + tr("command-line options") + "]                     " + "\n";
