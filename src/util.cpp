...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\8Bit
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\8Bit
    // Mac: ~/Library/Application Support/8Bit
    // Unix: ~/.8bit
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "8Bit";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "8bit.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "8bitd.pid"));
